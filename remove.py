...
def write_groups(params):
    ...
    if not os.path.exists(params.group_dir):
...
def remove_groups(params):
    ...
    :params.sentence_file: file of sentences to be adjusted
    '''

    if not os.path.exists(params.trim_dir):
